...
function App() {
  ...
  const powers = [
    ...
    { id: 'wildcard', name: 'Wildcard', cost: 100, cd: 30, action: activateWildcard, icon: '🃏', remote: false },
    ...
    // === NEW 12 POWERS ===
    { id: 'garbage_rain', name: 'Chuva Lixo', cost: 400, cd: 180, action: () => {}, icon: '🗑️', remote: true },
    { id: 'sticky', name: 'Grudento', cost: 400, cd: 160, action: () => {}, icon: '🍯', remote: true },
    { id: 'metamorph', name: 'Metamorfose', cost: 400, cd: 160, action: () => {}, icon: '🦎', remote: true },
    { id: 'ghost_shadows', name: 'Sombras', cost: 150, cd: 100, action: () => {}, icon: '👻', remote: true },
    { id: 'point_rain', name: 'Chuva Pts', cost: 400, cd: 120, action: activatePointRain, icon: '🧩', remote: false },
    { id: 'brittle', name: 'Quebradiça', cost: 600, cd: 160, action: () => {}, icon: '💔', remote: true },
    { id: 'anistia', name: 'Anistia', cost: 2500, cd: 300, action: () => {}, icon: '⚖️', remote: true },
    { id: 'popup', name: 'Pop-up', cost: 100, cd: 60, action: () => {}, icon: '📢', remote: true },
    ...
    { id: 'scatter_bomb', name: 'Dispersão', cost: 1100, cd: 180, action: () => {}, icon: '💣', remote: true },
    // === NEWEST 12 POWERS ===
    { id: 'laser', name: 'Laser', cost: 300, cd: 120, action: activateLaser, icon: '🔦', remote: false },
    { id: 'terremoto', name: 'Terremoto', cost: 2000, cd: 500, action: () => {}, icon: '🫨', remote: true },
    { id: 'upside_down', name: 'Virou ai?', cost: 1000, cd: 180, action: () => {}, icon: '🙃', remote: true },
    ...
    { id: 'lixo_falso', name: 'Lixo Falso', cost: 300, cd: 120, action: () => {}, icon: '👻', remote: true },
    { id: 'inflacao', name: 'Inflação', cost: 400, cd: 180, action: () => {}, icon: '📈', remote: true },
    { id: 'giro_louco', name: 'Giro Louco', cost: 500, cd: 120, action: () => {}, icon: '🌀', remote: true },
    { id: 'paralisia', name: 'Paralisia', cost: 2500, cd: 500, action: () => {}, icon: '🧊', remote: true },
