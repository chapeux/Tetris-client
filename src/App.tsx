...
const powers = [
    ...
    { id: 'flicker', name: 'Flicker', cost: 100, cd: 120, action: () => {}, icon: '💡', remote: true },
    { id: 'curse', name: 'Curse', cost: 500, cd: 120, action: () => {}, icon: '💀', remote: true },
    { id: 'concrete', name: 'Concrete', cost: 1000, cd: 120, action: () => {}, icon: '🧱', remote: true },
    { id: 'swap_board', name: 'Swap Board', cost: 1500, cd: 120, action: () => {}, icon: '↔️', remote: true },
    ...
    { id: 'miopia', name: 'Miopia', cost: 800, cd: 300, action: () => {}, icon: '👓', remote: true },
    { id: 'flashbang', name: 'Flashbang', cost: 150, cd: 120, action: () => {}, icon: '⚪', remote: true },
